...
import { Cpu, Zap, Search, Filter, MoreVertical, Plus, CheckCircle2, AlertTriangle, Info, User, Globe, Copy, Check, Terminal, CircuitBoard, Bell, Shield, Link, CreditCard, Lock, Smartphone, Github, Mail, Activity } from 'lucide-react';
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between py-2">
                    ...
                    <button className={`w-10 h-6 rounded-full p-1 transition-colors duration-300 flex-shrink-0 ${item.active ? 'bg-primary' : 'bg-white/20'}`}>
        ...
        {activeTab === 'Security' && (
          <div className="space-y-6">
            <Card>
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-sm font-bold mb-3 flex items-center gap-2"><Lock size={14} className="text-white/50" /> Change Password</h4>
                  <div className="space-y-3">
                    <input type="password" placeholder="Current Password" className="w-full bg-white/5 border border-white/10 rounded-lg py-2 px-3 text-sm focus:outline-none focus:border-primary/50 placeholder:text-white/30" />
                    <input type="password" placeholder="New Password" className="w-full bg-white/5 border border-white/10 rounded-lg py-2 px-3 text-sm focus:outline-none focus:border-primary/50 placeholder:text-white/30" />
                    <input type="password" placeholder="Confirm New Password" className="w-full bg-white/5 border border-white/10 rounded-lg py-2 px-3 text-sm focus:outline-none focus:border-primary/50 placeholder:text-white/30" />
                    <button className="bg-white/10 hover:bg-white/20 text-white text-sm font-medium py-2 px-4 rounded-lg transition-colors">Update Password</button>
                  </div>
                </div>
                ...
                <div className="border-t border-white/5 pt-4">
                  <div className="flex items-center justify-between mb-2">
                    <div>
                      <h4 className="text-sm font-bold flex items-center gap-2"><Smartphone size={14} className="text-white/50" /> Two-Factor Auth (2FA)</h4>
                ...
                <div className="border-t border-white/5 pt-4">
                  <h4 className="text-sm font-bold mb-3 flex items-center gap-2"><Activity size={14} className="text-white/50" /> Active Sessions</h4>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center bg-white/5 p-3 rounded-lg border border-primary/20">
                      <div>
                        <p className="text-xs font-bold text-primary">Windows • Chrome (Current)</p>
                        <p className="text-[10px] text-white/40">Amman, JO • IP: 192.168.1.1</p>
                      </div>
                    </div>
                    <div className="flex justify-between items-center bg-white/5 p-3 rounded-lg">
                      <div>
                        <p className="text-xs font-bold">iPhone 13 • Safari</p>
                        <p className="text-[10px] text-white/40">Amman, JO • 2 days ago</p>
                      </div>
        ...
        {activeTab === 'Connected Accounts' && (
          <div className="space-y-6">
            <Card>
              ...
              <p className="text-sm text-white/40 mb-6">Link external services to log in faster and sync your data.</p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 rounded-xl border border-white/5 hover:border-white/10 transition-colors">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#333] text-white rounded-full flex items-center justify-center">
                      <Github size={20} />
                    </div>
                    <div>
                  ...
                  <button className="text-xs text-white/70 hover:text-white font-medium bg-white/10 px-3 py-1.5 rounded-lg">Connect</button>
                </div>
              </div>
            </Card>
          </div>
        ...
        {activeTab === 'Billing' && (
          <div className="space-y-6">
            <Card>
              ...
              <div className="bg-gradient-to-br from-emerald-900/40 to-black/40 border border-emerald-500/20 rounded-xl p-5 mb-6 relative overflow-hidden">
                ...
                <div className="flex justify-between items-start relative z-10">
                  <div>
                    ...
                    <h4 className="text-2xl font-bold mt-2">Pro <span className="text-sm text-white/50 font-normal">/ $15.00 mo</span></h4>
                    <p className="text-xs text-white/40 mt-1">Next billing date: June 1, 2026</p>
                  </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-xl border border-white/5 bg-white/5 mb-6">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-8 bg-[#1a1f2b] rounded flex items-center justify-center border border-white/10">
                ...
                <button className="text-xs text-white/50 hover:text-white font-medium">Edit</button>
              </div>

              <div className="flex justify-between items-center border-t border-white/5 pt-4">
                <span className="text-sm text-white/70">Billing History</span>
